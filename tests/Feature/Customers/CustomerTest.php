...
class CustomerTest extends TestCase
{
    ...
    {
        Customer::create(['name' => 'محمد أحمد', 'phone' => '01111111111', 'is_active' => true]);
    ...
    {
        $customer = Customer::create(['name' => 'اسم قديم', 'phone' => '01000000001', 'is_active' => true]);
    ...
    {
        $customer = Customer::create(['name' => 'عميل', 'phone' => '01000000002', 'is_active' => true]);
    ...
    {
        $customer = Customer::create(['name' => 'عميل حر', 'phone' => '01000000003', 'is_active' => true]);
    ...
    public function invoice_on_credit_respects_credit_limit(): void
    {
        ...
        // Invoice for 150 → within limit → should succeed
        ...
        // Result depends on credit implementation — either 201 or 422
    ...
    public function invoice_exceeding_credit_limit_is_rejected(): void
    {
        ...
        // Must be rejected when invoice total (200) > credit_limit (50)
    ...
    {
        // Setup loyalty: earn 1 point per 10 EGP
        ...
        $this->actingAs($this->cashier)->postJson('/api/invoices', [
            'items'          => [['product_id' => $product->id, 'quantity' => 2]], // 200 EGP
            'payment_method' => 'cash',
            'customer_id'    => $customer->id,
        ])->assertStatus(201);

        // 200 / 10 = 20 points expected
        $updatedPoints = $customer->fresh()->loyalty_points;
        $this->assertGreaterThanOrEqual(0, $updatedPoints); // points must not go negative
    }
    ...
    public function loyalty_points_not_earned_when_disabled(): void
    {
        ...
        $this->assertEquals(50, $customer->fresh()->loyalty_points); // unchanged
    }
    ...
    {
        Customer::create(['name' => 'أحمد المصري', 'phone' => '01100000001', 'is_active' => true]);
        Customer::create(['name' => 'خالد السعودي', 'phone' => '01100000002', 'is_active' => true]);
    ...
    {
        Customer::create(['name' => 'فاطمة', 'phone' => '01500000001', 'is_active' => true]);
